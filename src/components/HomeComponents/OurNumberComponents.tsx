...
const OurNumberComponents = () => {
  const numberCards = [
    ...
    { title: "Global Customers", value: "15+", bg: "#5a5755" },
  ];
      ...
      <section className="px-4 py-8 bg-white sm:px-6 lg:px-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 gap-8 pt-8 mx-auto text-white lg:gap-12 max-w-7xl lg:grid-cols-2 lg:pt-16">
          ...
          <motion.div
            ...
            className="grid grid-cols-2 gap-2 font-serif font-bold sm:grid-cols-3 sm:gap-4"
          >
            {/* Title Card */}
            <motion.div
              custom={0}
              ...
              whileHover="hover"
              className="flex flex-col items-center justify-center w-full h-32 col-span-2 p-3 mx-auto font-serif border border-white sm:col-span-1 sm:p-4 lg:p-6 text-stone-600 sm:h-40 lg:h-56 sm:w-32 lg:w-40 sm:mx-0"
            >
              <span className="text-sm leading-tight text-center sm:text-lg lg:text-2xl">
                NUMBERS THAT DEFINE US
              </span>
            ...
            {numberCards.map((card, i) => (
              <motion.div
                ...
                variants={{cardVariants}}
                whileHover="hover"
                className={`flex items-center justify-center p-2 sm:p-3 border border-white h-32 sm:h-40 lg:h-56 w-full sm:w-32 lg:w-40 ${
                  card.bg.startsWith("gray") ? `bg-${card.bg}` : `bg-[${card.bg}]`
                } text-white`}
              >
                <motion.div
                  variants={{hoverCard}}
                  className="box-border flex flex-col items-center justify-center w-full h-full p-2 border border-white sm:p-3 lg:p-4"
                >
                  <span className="text-2xl font-bold sm:text-3xl lg:text-4xl">
                    {card.value}
                  </span>
          ...
          <motion.div
            ...
            className="flex flex-col items-start mt-8 lg:flex-row lg:mt-0"
          >
            {/* Image */}
            <motion.div
              variants={{imageHover}}
              whileHover="hover"
              className="w-full mb-6 lg:w-auto lg:-mr-10 lg:mb-0 xl:-mr-12"
            >
              <img
                src="/dummy.jpg"
                alt="Fashion business meeting"
                className="
                  ...
                  sm:w-80 sm:h-64
                  md:w-96 md:h-72
                  lg:w-[26rem] lg:h-[29.5rem]
                  xl:w-[28rem] xl:h-[31rem]
                  rounded-md 
                  mx-auto lg:mx-0
                "
              />
            ...
            <div className="w-full lg:max-w-[18rem] px-4 lg:px-0">
              ...
              <ol className="space-y-3 text-sm text-gray-700 list-decimal list-inside sm:space-y-4 sm:text-base marker:text-3xl sm:marker:text-4xl lg:marker:text-5xl marker:font-bold marker:font-serif">
                ...
                <li className="leading-relaxed">Focus on sustainable product offers.</li>
                <li className="leading-relaxed">
                  Existing sourcing and production presence in key low-cost and
                  duty-free countries of the world.
                </li>
