...
//           {/* Top CEO */}
//           <div className="w-[18rem]"> {/* Same width as other cards */}
//             {teamMembers
//               .filter((member) => member.position === "CEO")
//               .map((ceo, index) => (
//                 <div
//                   key={index}
//                   className="relative w-full mx-auto overflow-hidden rounded-md shadow-lg cursor-pointer group"
//                 >
//                   <img
//                     src={ceo.image}
//                     alt={ceo.name}
...
//       p-5 flex flex-col justify-end h-[9rem]" // 50% of card height
//                   >
...
//                       {ceo.position}
//                     </p>
//                     <p className="text-xs text-white/80 drop-shadow">{ceo.region}</p>
//                     <a
//                       href={ceo.linkedin}
//                       target="_blank"
...
//           {/* Bottom 6 members in 3 + 3 pyramid */}
...
//                     <div
//                       key={index}
//                       className="relative overflow-hidden rounded-md shadow-lg cursor-pointer group w-[18rem]"
//                     >
//                       <img
//                         src={member.image}
//                         alt={member.name}
...
//         transition-transform duration-500 ease-out
//         bg-black/15 backdrop-blur-lg border-t border-white/20
//         p-5 flex flex-col justify-end h-[11rem]" // 50% height
//                       >
//                         <p className="absolute text-white top-4 left-4 group-hover:hidden">
//                           {member.name}
//                         </p>
...
//           <h3 className="mb-4 text-2xl font-bold lg:text-3xl text-stone-800">
//             Leadership Excellence
//           </h3>
//           <p className="max-w-4xl mx-auto text-lg leading-relaxed text-stone-600">
//             Our management team combines deep industry expertise with innovative thinking, 
//             ensuring strategic growth and operational excellence across all global markets. 
//             Together, we're building the future of our industry through collaborative leadership and unwavering commitment to excellence.
//           </p>
